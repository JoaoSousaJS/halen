...
const mockUsers = [
  { id: 'u-1', name: 'Maya Chen', role: 'Patient', status: 'Active', plan: 'HALEN+', lastLoginAt: new Date().toISOString(), isFlagged: false },
  { id: 'u-2', name: 'Dr. House', role: 'Doctor', status: 'PendingReview', plan: null, lastLoginAt: null, isFlagged: true },
];
